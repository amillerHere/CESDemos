...
declare namespace H.data.heatmap.Provider {
  type Options = { assumeValues ? : boolean , coarseness ? : number , colors ? : H.data.heatmap.Colors , max ? : number , min ? : number , opacity ? : number , sampleDepth ? : number , tileSize ? : number , type ? : string } ;
}
...
declare namespace H.map.SpatialStyle {
  ...
  type Options = { fillColor ? : string , lineCap ? : string , lineDash ? : number [] , lineDashOffset ? : number , lineHeadCap ? : string , lineJoin ? : string , lineTailCap ? : string , lineWidth ? : number , miterLimit ? : number , strokeColor ? : string } ;
}
declare namespace H.map {
  /**
...
declare namespace H.map.provider.ImageTileProvider {
  type Options = { crossOrigin ? : string | null , getCopyrights ? : (a : H.geo.Rect , b : number ) => any , getURL : (a : number , b : number , c : number ) => string | undefined , headers ? : GlobalObject , max ? : number , min ? : number , opacity ? : number , tileSize ? : number , uri ? : string } ;
}
declare namespace H.map.provider {
  /**
...
declare namespace H.service {
   ...
   *
   * For China, only `map` layer is available.
   */
  type MapType = { base : H.map.layer.TileLayer , basenight ? : H.map.layer.TileLayer , labels : H.map.layer.TileLayer , map : H.map.layer.TileLayer , mapnight ? : H.map.layer.TileLayer , trafficincidents ? : H.map.layer.MarkerTileLayer , transit ? : H.map.layer.TileLayer , xbase : H.map.layer.TileLayer , xbasenight ? : H.map.layer.TileLayer } ;
  /**
...
declare namespace H.service {
  /**
   * This property specifies a collection of pre-configured HERE layers.
   *
   * For China, only the `vector.normal.map` layer is available.
   */
  type DefaultLayers = { raster : { normal : H.service.MapType , satellite : H.service.MapType , terrain : H.service.MapType } , vector : { normal : { map : H.map.layer.TileLayer , traffic : H.map.layer.TileLayer , trafficincidents : H.map.layer.MarkerTileLayer , truck : H.map.layer.TileLayer } } } ;
}
declare namespace H.service {
  /**
...
declare namespace H.service {
  ...
  class Platform {
     ...
     *
     * For China, only `vector.normal.map` layer is available.
     *
     * - `vector`
     * - `normal`
     ...
     * @param opt_pois A Boolean value indicating if POIs are displayed on the map (`true`), valid for both Vector Tile API and Map Tile API. For Map Tile API, a mask for the POI Categories can be provided as described in the Map Tile API documentation - [POI Categories](https://developer.here.com/documentation/map-tile/dev_guide/topics/resource-meta-pois.html). By default POIs are disabled.
     */
     ...
     * [HERE Data Hub](https://developer.here.com/documentation/data-hub/dev_guide/index.html).
     * @param options Configuration options for the Data Hub service.
     */
...
declare namespace H.service.Platform {
  type DefaultLayersOptions = { crossOrigin ? : string | null , engineType ? : number , lg ? : string , lg2 ? : string , pois ? : boolean , politicalView ? : string , ppi ? : number , style ? : string , tileSize ? : number } ;
...
declare namespace H.service.omv {
   ...
   *
   * For China, only the engines in {@link H.Map.EngineType} are available.
   */
  class Provider extends H.map.provider.RemoteTileProvider {
    /**
     * This class represents a provider for continuous fetching of HERE Optimized Map Visualization (OMV) tiles.
...
declare namespace H.service.omv {
  ...
  class Service extends H.service.Service {
     ...
     * @param opt_options The options to instantiate the provider
     */
    createLayer (style : H.map.render.Style < any > , opt_options ? : H.service.omv.Provider.Options ) : H.map.layer.TileLayer ;
    /**
...
declare namespace H.service.omv.Service {
  type Options = { baseUrl ? : H.service.Url , headers ? : GlobalObject , mapVersion ? : string , path ? : string , subDomain ? : string } ;
}
...
declare namespace H.service.xyz {
  /**
   * This class represents a provider for fetching data
   * from [HERE Data Hub API](https://developer.here.com/documentation/data-hub/dev_guide/index.html).
   * The provider could be used only with the `H.Map.EngineType.WEBGL` rendering engine.
   */
  class Provider extends H.map.provider.RemoteTileProvider {
    /**
     ...
     * from [HERE Data Hub API](https://developer.here.com/documentation/data-hub/dev_guide/index.html).
     * The provider could be used only with the `H.Map.EngineType.WEBGL` rendering engine.
     * @param service The Data Hub service instance.
     * @param spaceId Space ID that defines a given "space" resource.
     * @param opt_options The configuration options for the provider.
     */
    constructor (service : H.service.xyz.Service , spaceId : string , opt_options ? : H.service.xyz.Provider.Options ) ;
    getCopyrights (a ? : H.geo.Rect , b ? : number ) : H.map.ICopyright [] | null ;
    /**
     * To obtain the style used for rendering the provider data.
     */
    getStyle ( ) : H.map.render.Style < any > ;
...
declare namespace H.service.xyz.Provider {
  type Options = { engineType ? : H.Map.EngineType , max ? : number , min ? : number , parameters ? : H.service.ServiceParameters } ;
}
declare namespace H.service.xyz {
  /**
   * This class encapsulates the [HERE Data Hub API](https://developer.here.com/documentation/data-hub/dev_guide/index.html)
   * in a service stub, providing methods to access its resources.
   *
   * It's not allowed to call the constructor directly (an `IllegalOperationError` is thrown).
   * Instead an instance of this Service can be retrieved by calling the factory method
  ...
  class Service extends H.service.Service {
     ...
     * See [Data Hub API Reference - Delete multiple features from the space](https://developer.here.com/documentation/data-hub/api-reference-swagger.html#operation%2FdeleteFeatures)
     * @param spaceId Space ID that defines a given "space" resource.
     ...
     * @param onError A callback function to be called in case of failed request.
     */
    deleteFeatures (spaceId : string , params : H.service.ServiceParameters , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
     * To fetch all of the features found in the provided bounding box.
     * See [Data Hub API Reference - Get features in bounding box](https://developer.here.com/documentation/data-hub/api-reference-swagger.html#operation%2FgetFeaturesByBBox).
     * @param spaceId Space ID that defines a given "space" resource.
     * @param params Service parameters to be added to the request.
     * @param onResult A callback function to be called with an object containing feature collection.
     * @param onError A callback function to be called in case of failed request.
     */
    getFeaturesByBoundingBox (spaceId : string , params : H.service.ServiceParameters , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
     * To fetch all of the features found for the provided list of ids.
     * See [Data Hub API Reference - Get features by ID](https://developer.here.com/documentation/data-hub/api-reference-swagger.html#operation%2FgetFeatures).
     * @param spaceId Space ID that defines a given "space" resource.
     * @param params Service parameters to be added to the request.
     * @param onResult A callback function to be called with an object containing feature collection.
     * @param onError A callback function to be called in case of failed request.
     */
    getFeaturesById (spaceId : string , params : H.service.ServiceParameters , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
     * To retrieve a single space data.
     * See [Data Hub API Reference - Get a space by ID](https://developer.here.com/documentation/data-hub/api-reference-swagger.html#operation%2FgetSpace).
     * @param spaceId Space ID that defines a given "space" resource.
     * @param onResult A callback function to be called with an object describing the "space" resource.
     * @param onError A callback function to be called in case of failed request.
     */
    getSpace (spaceId : string , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
     ...
     * See [Data Hub API Reference - List spaces](https://developer.here.com/documentation/data-hub/api-reference-swagger.html#operation%2FgetSpaces).
     ...
     * @param onError A callback function to be called in case of failed request.
     * @param opt_params Optional service parameters.
     */
    getSpaces (onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any , opt_params ? : H.service.ServiceParameters ) : H.util.ICancelable ;
    /**
     * To retrieve a statistical information about the space.
     * See [Data Hub API Reference - Get statistics](https://developer.here.com/documentation/data-hub/api-reference-swagger.html#operation%2FgetStatistics).
     * @param spaceId Space ID that defines a given "space" resource.
     * @param onResult A callback function to be called with an object containing statistical information about the space.
     * @param onError A callback function to be called in case of failed request.
     */
    getStatistics (spaceId : string , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
     * To create or patch features.
     * See [Data Hub API Reference - Modify features in the space](https://developer.here.com/documentation/data-hub/api-reference-swagger.html#operation%2FpostFeatures)
     *
     ...
     */
    postFeatures (spaceId : string , geojsonObject : GlobalObject , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any , opt_params ? : H.service.ServiceParameters ) : H.util.ICancelable ;
    /**
     * To create or replace the provided features.
     * See [Data Hub API Reference - Create or replace multiple features](https://developer.here.com/documentation/data-hub/api-reference-swagger.html#operation%2FputFeatures)
     *
     ...
     * @param opt_params Service parameters to be added to the request.
     */
    putFeatures (spaceId : string , geojsonObject : GlobalObject , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any , opt_params ? : H.service.ServiceParameters ) : H.util.ICancelable ;
    /**
     * To search for features in the space.
     * See [Data Hub API Reference - Search for features](https://developer.here.com/documentation/data-hub/api-reference-swagger.html#operation%2FsearchForFeatures).
     * @param spaceId Space ID that defines a given "space" resource.
     * @param onResult A callback function to be called with an object containing feature collection.
     * @param onError A callback function to be called in case of failed request.
     * @param opt_params Service parameters to be added to the request.
     */
    search (spaceId : string , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any , opt_params ? : H.service.ServiceParameters ) : H.util.ICancelable ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service.xyz.Service {
  type Options = { baseUrl ? : H.service.Url , headers ? : GlobalObject , path ? : string , subDomain ? : string , token : string } ;
}
...
declare namespace H.ui.MapSettingsControl {
  type Entry = { label : string , layer ? : H.map.layer.Layer } ;
